      ...
      <div className="profile-layout">
        ...
        <div className="profile-sidebar">
          <div className="profile-info">
            <img
              src={`https://ui-avatars.com/api/?name=${user?.username || 'Admin'}&background=random&size=150`}
              alt="Profile"
        ...
        <div className="profile-main">
          ...
          {!showPasswordReset && (
            <div className="text-center p-5">
              <MDBIcon fas icon="user-shield" size="3x" className="text-muted mb-3" />
              <h3 className="text-muted">Welcome to Your Admin Profile</h3>
